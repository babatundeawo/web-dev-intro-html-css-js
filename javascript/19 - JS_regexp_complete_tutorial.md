# 🔍 JavaScript Regular Expressions — Complete Beginner Lesson
### Patterns · Flags · Characters · Meta Characters · Assertions · Quantifiers · Groups · RegExp Object · Methods

> **Source:** W3Schools.com — `js_regexp` · `js_regexp_flags` · `js_regexp_characters` · `js_regexp_meta_characters` · `js_regexp_assertions` · `js_regexp_quantifiers` · `js_regexp_patterns` · `js_regexp_objects` · `js_regexp_methods`
