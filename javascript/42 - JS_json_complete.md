# JavaScript JSON — Complete Tutorial
### Topics Covered: JSON Intro · Syntax · JSON vs XML · Data Types · JSON.parse() · JSON.stringify() · JSON Objects · JSON Arrays · JSON & Servers · JSON with PHP · JSON to HTML · JSONP
