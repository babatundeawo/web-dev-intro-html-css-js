...
> **Source Curriculum:** W3Schools JavaScript — Data Types Module  
> **Level:** Beginner → Intermediate  
> **Covers:** `js_datatypes` · `js_datatypes_primitives` · `js_datatypes_objects` · `js_typeof` · `js_tostring` · `js_type_conversion`
